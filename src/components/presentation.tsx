...
export function Presentation() {
  ...
  const profile = {
    ...
    description:
      "Hey 👋I'm Sidharth, an AI engineer and multi-agent systems developer. I’ve worked hands-on with RAG pipelines, LangGraph/LangChain, and built production-grade AI agents integrated with Gmail and social platforms. I’m passionate about AI research, knowledge graphs, and building intelligent automation tools.",
    src: '/sidharthan-photo.jpg',
    fallbackSrc:
    ...
    <div className="mx-auto w-full max-w-5xl py-6 font-sans">
      <div className="grid grid-cols-1 items-center gap-10 md:grid-cols-2">
        ...
        <div className="flex flex-col space-y">
          ...
          >
            {['AI Engineer', 'Developer', 'Multi-Agent Systems', 'RAG', 'LangChain'].map(
              (tag) => (
                <span
                  key={tag}
