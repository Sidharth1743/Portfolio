...
export function Resume() {
  // Resume details
  const resumeDetails = {
    title: "Sidharthan's Resume",
    description: 'AI Engineer • Multi-Agent Systems Developer',
    fileType: 'PDF',
    lastUpdated: 'January 2025',
    fileSize: '0.5 MB',
    previewImageSrc: '/resume_sidharthan_preview.png',
    downloadUrl: '/resume_sidharthan.pdf',
  };
